...
class Student {
    ...
    public String toString() {
        ...
        String emails = Arrays.stream(getEmailContacts())
                .map(Contact::quoted)
                .collect(Collectors.joining(", ", "[", "]"));

        joiner.add(keyValueNoQuotes("emailKontakti", emails));
...
class Faculty {
    ...
    public Student getStudentWithMostContacts() {
        return Arrays.stream(students).max(Comparator.comparing(Student::getContactsSize)
                .thenComparing(Student::getIndex)).orElse(null);
